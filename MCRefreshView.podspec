...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhmch0329/MCRefreshView"
  ...
  s.author             = { "zhmch0329" => "zhang-minchao@hotmail.com" }
  # Or just: s.author    = "zhmch0329"
  # s.authors            = { "zhmch0329" => "zhang-minchao@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/zhmch0329"
  ...
  s.source       = { :git => "https://github.com/zhmch0329/MCRefreshView.git", :tag => "0.0.1" }
  ...
  s.source_files  = "MCRefreshView", "MCRefreshView/MCRefreshView/**/*.{swift}"
